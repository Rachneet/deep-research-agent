"""
Prompts used by various agents in the Deep Research Agent system.
"""
...
compress_research_human_message = """Please process and clean up all the research findings gathered above.

RESEARCH TOPIC: {research_topic}

Remember:
- Preserve all relevant information verbatim
- Include inline citations for every source
- Filter out think_tool calls - focus only on actual research findings
- Don't lose any sources or key information

Please provide your comprehensive, cleaned findings now."""
